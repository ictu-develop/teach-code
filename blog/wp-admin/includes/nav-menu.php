	...
	<div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
		...
		?>" id="tabs-panel-posttype-<?php echo $post_type_name; ?>-search">
			...
			<p class="quick-search-wrap">
				...
				<span class="spinner"></span>
				<?php submit_button( __( 'Search' ), 'small quick-search-submit hide-if-js', 'SubmitCode', false, array( 'id' => 'submit-quick-search-posttype-' . $post_type_name ) ); ?>
			</p>
	...
	<div id="taxonomy-<?php echo $taxonomy_name; ?>" class="taxonomydiv">
		...
		?>" id="tabs-panel-search-taxonomy-<?php echo $taxonomy_name; ?>">
			...
			<p class="quick-search-wrap">
				...
				<span class="spinner"></span>
				<?php submit_button( __( 'Search' ), 'small quick-search-submit hide-if-js', 'SubmitCode', false, array( 'id' => 'submit-quick-search-taxonomy-' . $taxonomy_name ) ); ?>
			</p>
